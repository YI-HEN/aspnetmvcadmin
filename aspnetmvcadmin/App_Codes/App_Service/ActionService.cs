...
public static class ActionService
{
    ...
    public static string ViewActionNo { get { return SessionService.GetValue("ViewActionNo"); } set { SessionService.SetValue("ViewActionNo", value); } }
    public static string ViewActionName { get { return SessionService.GetValue("ViewActionName"); } set { SessionService.SetValue("ViewActionName", value); } }
    public static string ViewPrgNo { get { return SessionService.GetValue("ViewPrgNo"); } set { SessionService.SetValue("ViewPrgNo", value); } }
    public static string ViewPrgName { get { return SessionService.GetValue("ViewPrgName"); } set { SessionService.SetValue("ViewPrgName", value); } }
    public static string ViewPrgInfo
    {
        get
        {
            string str_value = "";
            if (!string.IsNullOrEmpty(ViewPrgNo)) str_value += $"{ViewPrgNo} ";
            if (!string.IsNullOrEmpty(ViewPrgName)) str_value += ViewPrgName;
            return str_value;
        }
    }
    ...
    /// Row ID
    /// </summary>
    public static int RowId { get { return SessionService.GetIntValue("RowId"); } set { SessionService.SetValue("RowId", value); } }
    /// <summary>
    /// Row Data
    /// </summary>
    public static string RowData { get { return SessionService.GetValue("RowData"); } set { SessionService.SetValue("RowData", value); } }
    /// <summary>
    /// 取得預設 Home 名稱
    /// </summary>
    ...
    /// 新增按鈕 Class
    /// </summary>
    public static string ButtonClassCreate { get { return "btn btn-primary"; } }
    /// <summary>
    /// 修改按鈕 Class
    /// </summary>
    public static string ButtonClassEdit { get { return "btn btn-success"; } }
    /// <summary>
    /// 刪除按鈕 Class
    /// </summary>
    public static string ButtonClassDelete { get { return "btn btn-danger"; } }
    /// <summary>
    /// 存檔按鈕 Class
    /// </summary>
    public static string ButtonClassUpdate { get { return "btn btn-primary"; } }
    /// <summary>
    /// 返回按鈕 Class
    /// </summary>
    public static string ButtonClassReturn { get { return "btn btn-success"; } }
    /// <summary>
    /// 刪除按鈕確認程式
    /// </summary>
    public static string ButtonDeleteConfirm { get { return "return confirm('是否確定要刪除?');"; } }
    /// <summary>
    /// 取得目前的 Area 名稱
    /// </summary>
    /// <returns></returns>
    ...
    public static void SetPriorAction(string areaName, string controllerName, string actionName, object parmValue, string imageFolder)
    {
        PriorArea = areaName;
